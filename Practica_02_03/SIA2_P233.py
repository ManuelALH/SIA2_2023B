...
Original file is located at
    https://colab.research.google.com/drive/1N9CtNrXSipI860kfvvdDJmbK3IZgEbtO
"""
...
class Clasificador:
    ...
    def RegresionLogistica(self):
        ...
        plt.title("Precision de Regresion Logistica: {:.2f}".format(precision))
        plt.show()
        print(reporte)
    ...
    def kVecinos(self):
        ...
        plt.title("Precision de K Vecinos: {:.2f}".format(precision))
        plt.show()
        print(reporte)
    ...
    def naiveBayes(self):
        ...
        plt.title("Precision de Naive Bayes: {:.2f}".format(precision))
        plt.show()
        print(reporte)
    ...
    def redNeuronal(self):
        ...
        plt.title("Precision de Red Neuronal: {:.2f}".format(precision))
        plt.show()
        print(reporte)
